...
class NetworkManager {
    ...
    class func getEventsByCategory(page: Int,segmentId:String, completionhandler:@escaping (EventsModel) -> ()) {
    ...
    class func getEventsByKeyCat(page:Int,keyword:String, segmentId:String,completionhandler:@escaping (EventsModel) -> ()){
        
        _ = AF.request(baseURL,method: .get, parameters: ["keyword":keyword,"segmentId":segmentId, "page":page, "apikey":apiKey])
            .validate(statusCode: 200..<300)
            .validate(contentType: ["application/json"])
            .responseData { response in
    ...
    class func getEventsByKeyword(page: Int,keyword:String, completionhandler:@escaping (EventsModel) -> ()) {
           
        _ = AF.request(baseURL,method: .get, parameters: ["keyword":keyword, "page":page, "apikey":apiKey])
               .validate(statusCode: 200..<300)
               .validate(contentType: ["application/json"])
               .responseData { response in
